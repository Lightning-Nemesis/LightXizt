...
<nav>
    ...
    <form class="form-nav" action="" method="post">
    <fieldset>
        ...
        <button><a name="filter" style="color:white;text-decoration: none;">Filter</a></button>
    </form>
...
if(isset($_POST['filter'])){
  $domain=$_POST['domain'];
  $sql="SELECT * FROM startup WHERE domain='$domain'";
...
<article>
    ...
    <p><b><i>>Stake: <?php echo $result['stake']; ?>%</b></i></p><br>
        ...
        <form  action="bid.inc.php" method="post">
        <label>Amount:</label><input type="text" name="amount" style="width:20%"></input>
        <label>Equity</label><input type="text" name="stake" style="width:20%"></input><br>
        <button type="submit" name="bid"  style="width:20%">Bid</button>
        </form>
